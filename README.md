...
- [`low-effort-field-interventions.md`](defense/low-effort-field-interventions.md) — Simple, sustainable actions that disrupt field influence without depleting your attention, energy, or resources.
...
- [morning-phase-disruption.md](delivery/morning-phase-disruption.md) — Identifies tactics used to disrupt executive access and symbolic clarity during the sleep–wake transition.
